...
var doc = document.querySelector('#pictures')

for (let info of picArray) {
  ...
  figurecaption.innerText = info['caption']
  ...
  article.addEventListener('click', function(evt) {
    ...
    test.src = info['image']['large'];
    test.alt = info['title']
    dialogue.appendChild(test);
...
// edit: that made me laugh way too much
